...
class AlipayTradeService
{
    ...
    //支付宝网关地址
    public $gateway_url = "https://openapi.alipaydev.com/gateway.do"; //https://openapi.alipay.com/gateway.do
    ...
    public function __construct($alipay_config)
    {
        ...
        if (empty($this->appid) || trim($this->appid) == "") {
            die("appid should not be NULL!");
        }
        if (empty($this->private_key) || trim($this->private_key) == "") {
            die("private_key should not be NULL!");
        }
        if (empty($this->alipay_public_key) || trim($this->alipay_public_key) == "") {
            die("alipay_public_key should not be NULL!");
        }
        if (empty($this->charset) || trim($this->charset) == "") {
            die("charset should not be NULL!");
        }
        if (empty($this->gateway_url) || trim($this->gateway_url) == "") {
            die("gateway_url should not be NULL!");
        }
